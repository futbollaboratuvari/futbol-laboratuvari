...
function analysisClassification(item, modelScore, dataCompleteness, market, includeInCoupon) {
  ...
  if (couponRules.isCouponEligible(normalized)) {
    return {
      ...
      analysis_tier: "coupon",
      coupon_filter_reason: "Kupon kalite ve değer kapıları geçti.",
    };
  }
...
module.exports = { analysisClassification, buildCalibration, buildProAnalysisIndex, compactBttsAnalysis, compactMatch, compactMatchup, compactMetrics, compactTeamIntelligence, couponEligibility, main, matchId, selectProMatches, teamsOf };
