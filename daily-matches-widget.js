(() => {
  ...
  const injectStyle = () => {
    ...
    style.textContent = `
      .daily-widget-shell{position:relative;z-index:3;margin:22px clamp(18px,6vw,90px) 0;padding:18px;border:1px solid rgba(255,159,28,.3);border-radius:22px;background:linear-gradient(135deg,rgba(255,159,28,.08),transparent 34%),linear-gradient(180deg,rgba(8,23,48,.96),rgba(3,8,23,.97));box-shadow:0 24px 70px rgba(0,0,0,.38),inset 0 1px 0 rgba(255,255,255,.05)}
      .daily-widget-head{display:flex;align-items:flex-end;justify-content:space-between;gap:16px;margin-bottom:16px}.daily-widget-title{margin:0;color:#ffe08a;font-size:clamp(20px,2.2vw,30px);line-height:1.1}.daily-widget-subtitle{margin:6px 0 0;color:#aebbd0;font-size:13px}.daily-widget-count{display:inline-flex;align-items:center;gap:8px;padding:9px 12px;border:1px solid rgba(57,255,136,.34);border-radius:999px;background:rgba(57,255,136,.12);color:#c8ffdd;font-size:13px;font-weight:800;white-space:nowrap}.daily-widget-list{display:grid;gap:16px}.daily-league-block{overflow:hidden;border:1px solid rgba(255,159,28,.22);border-radius:18px;background:rgba(3,8,23,.6)}.daily-league-head{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px 14px;background:linear-gradient(90deg,rgba(255,159,28,.72),rgba(19,120,69,.62),rgba(3,8,23,.72));border-bottom:1px solid rgba(255,159,28,.28)}.daily-league-title{display:flex;align-items:center;gap:10px;min-width:0}.daily-league-flag{font-size:18px;line-height:1}.daily-league-name{color:#fff7d6;font-size:13px;font-weight:950;letter-spacing:.08em;text-transform:uppercase;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;text-shadow:0 1px 0 rgba(0,0,0,.28)}.daily-league-count{color:#ffffff;font-size:12px;font-weight:900;white-space:nowrap}.daily-table-scroll{overflow-x:auto}.daily-match-table{display:grid;min-width:1180px}.daily-match-header,.daily-match-row{display:grid;grid-template-columns:70px minmax(340px,1fr) 62px 62px 62px 66px 66px 66px 66px 118px;align-items:stretch}.daily-match-header{background:linear-gradient(180deg,rgba(35,48,49,.98),rgba(20,31,34,.98));color:#ffe08a;font-size:11px;font-weight:950;letter-spacing:.06em;text-transform:uppercase}.daily-match-header span,.daily-match-row>*{display:flex;align-items:center;min-height:44px;padding:9px 10px;border-right:1px solid rgba(255,255,255,.08);border-bottom:1px solid rgba(255,255,255,.07)}.daily-match-header span:last-child,.daily-match-row>*:last-child{border-right:0}.daily-match-row:nth-child(odd){background:rgba(255,255,255,.03)}.daily-match-row:nth-child(even){background:rgba(255,159,28,.025)}.daily-match-row.is-open{background:rgba(255,159,28,.085)!important;box-shadow:inset 3px 0 0 rgba(57,255,136,.68)}.daily-match-time{justify-content:center;color:#39ff88;font-size:17px;font-weight:950}.daily-match-teams{display:grid;grid-template-columns:minmax(0,1fr) 22px minmax(0,1fr);gap:8px;color:#f8fbff;font-size:14px;font-weight:850}.daily-team{display:flex;align-items:center;gap:8px;min-width:0}.daily-team-name{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.daily-team-logo{display:inline-flex;align-items:center;justify-content:center;flex:0 0 auto;width:26px;height:26px;border:1px solid rgba(255,159,28,.42);border-radius:999px;background:linear-gradient(180deg,rgba(255,159,28,.18),rgba(57,255,136,.08));color:#ffe08a;font-size:11px;font-weight:950;overflow:hidden}.daily-team-logo img{width:100%;height:100%;object-fit:contain}.daily-match-vs{justify-content:center;color:#aebbd0;font-size:12px;font-weight:900}.daily-odd{justify-content:center;background:rgba(255,255,255,.055);color:#ffffff;font-size:12px;font-weight:900}.daily-odd.is-empty{color:#738096;background:rgba(255,255,255,.025)}.daily-odd:hover{background:rgba(255,159,28,.18);color:#ffe08a}.daily-widget-status{justify-content:center;color:#ffe08a;font-size:11px;font-weight:800}.daily-status-pill{display:inline-flex;align-items:center;justify-content:center;padding:6px 9px;border-radius:999px;background:rgba(255,159,28,.16);color:#ffe08a;white-space:nowrap}.daily-detail-button{width:100%;min-height:36px;display:grid;grid-template-columns:28px 1fr 28px;align-items:center;gap:6px;border:1px solid rgba(255,159,28,.28);border-radius:999px;background:rgba(3,8,23,.74);color:#f8fbff;cursor:pointer;padding:5px 7px;box-shadow:inset 0 1px 0 rgba(255,255,255,.05)}.daily-detail-button:hover{border-color:rgba(57,255,136,.42);background:rgba(57,255,136,.08)}.daily-status-icon{display:inline-flex;align-items:center;justify-content:center;width:26px;height:26px;border-radius:999px;border:1px solid rgba(255,159,28,.30);background:rgba(255,159,28,.12);font-size:13px;line-height:1}.daily-odds-badge{display:inline-flex;align-items:center;justify-content:center;min-width:34px;height:26px;padding:0 7px;border-radius:999px;border:1px solid rgba(57,255,136,.30);background:rgba(57,255,136,.10);color:#c8ffdd;font-size:11px;font-weight:950;line-height:1;white-space:nowrap}.daily-chevron{display:inline-flex;align-items:center;justify-content:center;width:24px;height:24px;border-radius:999px;background:rgba(255,159,28,.16);color:#ffe08a;font-size:16px;line-height:1;transition:transform .18s ease,background .18s ease}.daily-detail-button[aria-expanded="true"] .daily-chevron{transform:rotate(180deg);background:rgba(57,255,136,.16);color:#c8ffdd}.daily-widget-empty{padding:18px;border:1px solid rgba(255,159,28,.18);border-radius:16px;background:rgba(3,8,23,.58);color:#aebbd0}@media(max-width:720px){.daily-widget-shell{margin:16px 14px 0;padding:14px}.daily-widget-head{align-items:flex-start;flex-direction:column}.daily-match-table{min-width:1120px}}
    `;
  ...
  const renderLeague = ({ league, items }) => `<article class="daily-league-block"><div class="daily-league-head"><div class="daily-league-title"><span class="daily-league-flag">${countryFlag(league)}</span><span class="daily-league-name">${escapeHtml(league)}</span></div><span class="daily-league-count">${items.length} maç</span></div><div class="daily-table-scroll"><div class="daily-match-table"><div class="daily-match-header"><span>Saat</span><span>Maç</span><span>1</span><span>X</span><span>2</span><span>Alt</span><span>Üst</span><span>Var</span><span>Yok</span><span>Detay</span></div>${items.map((match) => { const odds = mainOdds(match); return `<div class="daily-match-row" data-home="${escapeHtml(match.home || "Ev sahibi")}" data-away="${escapeHtml(match.away || "Deplasman")}"><div class="daily-match-time">${escapeHtml(match.time || "--:--")}</div><div class="daily-match-teams"><span class="daily-team">${logoHtml(match, "home")}<span class="daily-team-name">${escapeHtml(match.home || "Ev sahibi")}</span></span><span class="daily-match-vs">-</span><span class="daily-team">${logoHtml(match, "away")}<span class="daily-team-name">${escapeHtml(match.away || "Deplasman")}</span></span></div>${oddCell(odds.one)}${oddCell(odds.draw)}${oddCell(odds.two)}${oddCell(odds.under25)}${oddCell(odds.over25)}${oddCell(odds.bttsYes)}${oddCell(odds.bttsNo)}<span class="daily-widget-status">${detailButton(match, odds)}</span></div>`; }).join("")}</div></div></article>`;
  ...
  const render = (matches) => {
    ...
    const todaysMatches = matches.filter((match) => match.date === today).sort((a, b) => {
