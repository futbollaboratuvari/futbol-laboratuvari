(() => {
  ...
  const injectStyle = () => {
    ...
    style.textContent = `
      ...
      .site-footer .paytr-footer-links,.footer .paytr-footer-links{display:flex;flex-wrap:wrap;justify-content:center;gap:10px;margin-top:12px}.site-footer .paytr-footer-links a,.footer .paytr-footer-links a{color:#ffe08a;font-size:12px;font-weight:850;text-decoration:none}.site-footer .paytr-footer-contact,.footer .paytr-footer-contact{margin-top:10px;color:#aebbd0;font-size:12px}.site-footer .paytr-footer-contact a,.footer .paytr-footer-contact a{color:#c8ffdd;text-decoration:none;font-weight:850}
