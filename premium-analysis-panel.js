(() => {
  ...
  const render = (fixtures, archive) => {
    ...
    shell.innerHTML = `
      <div class="premium-head"><div><h2 class="premium-title">Özel Maç / Kupon Analizi</h2><p class="premium-subtitle">Birden fazla maç seçerek kupon analizi oluştur. Robot seçilen her maçı ayrı okur, sonucu sağdaki kupon kartında birleştirir.</p></div><span class="premium-lock">🔐 Ücretli Üye Alanı</span></div>
