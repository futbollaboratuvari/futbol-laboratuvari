(() => {
  ...
  const addStyle = () => {
    ...
    style.textContent = `
      ...
      @media (max-width: 560px){.results-fab{right:12px;bottom:12px;padding:9px 11px;font-size:12px;gap:6px}.results-panel{right:12px;bottom:60px;width:calc(100vw - 24px);max-height:55vh;border-radius:16px}.results-head{padding:12px}.results-list{padding:10px}}
    `;
