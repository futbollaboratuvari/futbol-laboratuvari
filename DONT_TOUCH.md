...
- Amaç/kök neden: Güncel data/robot-analysis.json yaklaşık 7,5 MB seviyesine çıktı. Korumalı backend server-lib/pro-index-from-github.js dosyayı 4 MB ile sınırladığı için GitHub main üzerindeki güncel PRO çıktısı remote_pro_payload_too_large ile reddedilebiliyor ve /api/pro-analysis eski deployment fallback indeksine düşebiliyordu. Ayrıca analiz görünürlüğü ile kupon uygunluğu bazı sunum katmanlarında yeterince açık ayrılmıyordu. İlk tanı sayımında başlamamış 246 maçın 221'inde gerçek/uygun market analizi ve 32 kayıtta kaba skor/veri hazır eşiği bulunurken güncel kupon adayı 0 görüldü. Yeni katmanlı sınıflandırma tüm güncel projection üzerinde 226 görünür analiz, 29 pro_ready, 197 watch, 27 filtered ve 0 kupon adayı üretti; kupon yokluğu analiz yokluğu olarak yorumlanmamalıdır.
