...
- Test: tests/nesine-match-detail-source.test.js resmi kimlik kapısını, kısa matchCode reddini, takım kimliği doğrulamasını, puan tablosu/H2H parserini ve bölüm excerptlerini kilitler. tests/match-detail-center.test.js dış doğrulanmış kaynak önceliğini ve provenance taşımasını test eder. Ayrı Match Detail Data CI Node 20/24 hedefli syntax/regresyon koşusu eklendi. PR CI sonucu kapanışta güncellenecektir.
